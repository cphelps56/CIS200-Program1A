...
public abstract class Parcel
{
    ...
    {
        return String.Format("{4}{3}{3}Origin Address:{3}{0}{3}{3}Destination Address:{3}{1}{3}Cost: {2:C}",
            OriginAddress, DestinationAddress, CalcCost(), Environment.NewLine,GetType().ToString());
    }
}
